...
namespace LINQ.Exercises
{
    ...
    /// Create and implement the interface to achieve the desired outcome.
    ...
    public class OrderBy
    {
        ...
        public void OrderWordsAlphabetically_ReturnThreeWords()
        {
            ...
            Assert.True(result.SequenceEqual(new[] { "apple", "blueberry", "cherry" }));
        }
        ...
        public void OrderWordsAlphabetically_Return5Words()
        {
            ...
            Assert.True(result.SequenceEqual(new[] { "apple", "blueberry", "cherry", "tamarind", "zuchini" }));
        }
        ...
        public void OrderWordsBySecondLetter_Return5Words()
        {
            ...
            Assert.True(result.SequenceEqual(new[] { "tamarind", "cherry", "blueberry", "apple", "zuchini" }));
        }
        ...
        public void OrderWordsByFirstLetterDescendingAlphabetically_Return5Words()
        {
            ...
            Assert.True(result.SequenceEqual(new[] { "zuchini", "tamarind", "cherry", "blueberry", "apple", }));
        }
        ...
        public void OrderWordsByByLength_Return3Words()
        {
            ...
            Assert.True(result.SequenceEqual(new[] { "apple", "cherry", "blueberry" }));
        }
        ...
        public void OrderByPeopleByPersonsLastNameAlphabetically_returnOrderedPeople()
        {
            ...
            Assert.True(result.SequenceEqual(new[]
            {
        ...
        public void OrderAssumingSpecialCondition_ReturnSpecialEnumeration()
        {
            ...
            Assert.True(result.SequenceEqual(new[] { "apple", "zuchini", "blueberry", "cherry", "tamarind" }));
        }
        ...
        public void OrderByLengthAndThenAlphabetically_returnStringNumberation()
        {
            ...
            Assert.True(result.SequenceEqual(new[] { "one", "six", "two", "five", "four", "nine", "zero", "eight", "seven", "three" }));
        }
        ...
        public void OrderByLengthThenAlphabeticallyIgnoringCase_returnStringEnumeration()
        {
            ...
            Assert.True(result.SequenceEqual(new[] { "aPPLE", "AbAcUs", "bRaNcH", "cHeRry", "ClOvEr", "BlUeBeRrY" }));
        }
        ...
        public void ComplexQuery_returnStringEnumeration()
        {
            ...
            Assert.True(result.SequenceEqual(new[] { "nine", "eight", "six", "five" }));
        }
    }
}
